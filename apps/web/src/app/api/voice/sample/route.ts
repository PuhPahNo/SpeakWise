...
import { z } from 'zod';
import { synthesizeSpeech, getVoiceById } from '@speakwise/ai';
...
const DEFAULT_SAMPLE_EN =
  "Hi, I'm Wise, your Italian tutor. Let's start with a quick warm-up.";
...
export async function POST(req: Request) {
  try {
    ...
    const text =
      body.text ?? (body.language === 'en' ? DEFAULT_SAMPLE_EN : DEFAULT_SAMPLE_IT);
