...
import { BarChart3, BookOpen, Home, MessageSquareText, User } from 'lucide-react';
import Link from 'next/link';
import { usePathname } from 'next/navigation';
import { useEffect, useState } from 'react';

// Mobile bottom-tab nav. Mirrors the desktop left-rail order:
// Home · Chat · Progress · Course · Profile.
const tabs = [
  { href: '/command-center', en: 'Home', it: 'Casa', Icon: Home },
  { href: '/chat', en: 'Chat', it: 'Conversa', Icon: MessageSquareText },
